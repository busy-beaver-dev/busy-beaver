...
DIGITALOCEAN_SPACES_BUCKET_NAME = os.getenv("DIGITALOCEAN_SPACES_BUCKET_NAME", None)
DIGITALOCEAN_SPACES_BASE_URL = os.getenv("DIGITALOCEAN_SPACES_BASE_URL", None)
LOGOS_FOLDER = os.getenv("LOGOS_FOLDER", None)
