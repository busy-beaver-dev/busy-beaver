"""add github configuration information table

Revision ID: a25bdc37f2be
Revises: 9bd99c734716
Create Date: 2019-06-29 01:32:33.893627
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("time_to_post", sa.Integer(), nullable=False),
